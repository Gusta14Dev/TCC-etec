			...
			if (isset($_POST['cadastrar'])) {
				...
				//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
					...
					if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta']. $nome_final)){
						...
						$insert="INSERT INTO `tb_funcionario`(`nm_funcionario`, `nm_sobrenome`, `nm_foto`, `nm_cargo`, `ds_cargo`, `id_usuario`) VALUES ('$nome','$sobrenome','foto-funcionario/$nome_final','$cargo','$descr_cargo', '$usuario')";
