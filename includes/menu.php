...
<!-- Menu fixo -->
 <nav class="navbar-expand-lg navbar-menu">
  <a class="navbar-brand ml-auto ml-lg-3 float-left" href="#">Etec de Itanhaém</a>
  <button class="navbar-toggler p-25 border-0 float-right " type="button" data-toggle="menu">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="menu-option navbar-collapse offcanvas-collapse p-0">
    <ul class="navbar-nav mr-auto">
      ...
      <a class="menu-link pr-3" href="tcc.php">
        <li class="menu-item">
          <span>TCC</span>
        </li>
      </a>
      <div class="container-login">
      <a class="menu-link pl-3 pr-3" href="login.php">
        <li class="menu-item">
          <span>LOGIN</span>
        </li>
      </a>
