<?php
  ...
  $itens = $_GET['itens'];
	$select0= "SELECT * FROM `tb_usuario` WHERE cd_usuario = $itens and id_tipo = 4 ";
	if($diretor = $mysqli->query($select0)){
	}else {
		echo "Não foi!!!!";
	}
?>
...
<div class="container-table" style="margin-top:100px;">
  ...
  <?php
	echo '<div class="mr-sm-5 mt-5 mt-sm-0 mr-0" id="foto_diretor"  ><img class="img-fluid"
    src="'.$obj->nm_foto.'"></div>';
